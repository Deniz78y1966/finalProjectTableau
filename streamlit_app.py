...
data_path = './data/netflix-titles.csv'
if not os.path.exists(data_path):
    st.error(f"Error: The file '{data_path}' does not exist. Please upload the file to the correct directory.")
else:
...
def comparacion():
    ...
    def listedinTitulos():
        try:
            df =  pd.read_csv('./data/netflix-titles.csv', on_bad_lines='skip') 
